  ...
  return (
    <main className="row-start-2 flex max-w-[800px] flex-col items-center gap-[32px] sm:items-start">
      ...
      <p className="text-text">
        ...
        Dopehead, Jean + Deans Bakery, CKCU FM Ottawa, and more. Whether it’s a
      ...
      <p className="text-text">
        ...
        Dionysian (published in NYC) and Sidewalk Plants (Montreal publication).
        When I’m not drawing, you can find me on long-haul bike adventures,
        hanging out with dogs, or practicing my French. Ilove working on
        commissions and bringing the vision and stories of others to life on the
        page (or screen). If you’re looking for unique artwork or design, let’s
        chat!
      </p>
    </main>
  );
