        ...
        <CardContent>
          <CardDescription className="flex flex-col items-center gap-[16px]">
            <p className="text-text text-center font-semibold">
              I’m an illustrator based in Montreal, and I’m all about creating
              colourful, fun art that tells a story. Not too long ago, I made
              the leap from my 9-to-5 to dive headfirst into illustration and
            ...
            <p className="text-text text-center font-semibold">
              ...
              more. Whether it’s a logo, a mural, or a limited-edition tote bag,
              I’m here to make it happen.
            </p>
            <p className="text-text text-center font-semibold">
              I’ve showcased my personal art at exhibitions like the Sketch at
              Saw Gallery, and solo exhibitions, like Super Happy Artworks by
